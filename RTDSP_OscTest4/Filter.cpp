...
void Filter::calculateCoefficients(int const type,double const frequency,double const sample_rate,double const q,double const db_gain,bool q_is_bandwidth)
{
...
float Filter::processSamples(float sound)
{
            // filter
            in0=sound;
            yn = b0a0*in0 + b1a0*in1 + b2a0*in2 - a1a0*ou1 - a2a0*ou2;
