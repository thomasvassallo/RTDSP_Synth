...
bool setup(BeagleRTContext *context, void *userData)
{
		...
		env.setTargetRatioA(20);
		env.setTargetRatioDR(20);

		env.setAttackRate(.1 * context->audioSampleRate);  // .1 second
...
void render(BeagleRTContext *context, void *userData)
{
	...
	filter1.calculateCoefficients(0, 200, context->audioSampleRate, 1, 0, 0); //Calculate the coefficients
